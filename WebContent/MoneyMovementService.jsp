    ...
    %>
			<div class="container">
				...
				<!-- <div id="fh5co-menu-logo"> -->
					<!-- START #fh5co-logo -->
					<h1 id="fh5co-logo" class="pull-left"><a href="index.html"><img src="images/logo.png" alt="Architect Corner" width=50 height=50></a><p>Architect Corner</p></h1>
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li>
									<a href="right-sidebar.html">Citi Banking</a>
									 		<ul class="fh5co-sub-menu">
												<li><A HREF="CustomerService.jsp?code=<%= code%>"> Customers</A> </li>
												<li><a href="ReferenceService.jsp?code=<%= code%>">Reference Data</a></li>
												<li><a href="OnBoardingService.jsp?code=<%= code%>">OnBoarding</a></li>
												<li><a href="CardsService.jsp?code=<%= code%>">Cards</a></li>
												<li><a href="MoneyMovementService.jsp?code=<%= code%>">Money Movement</a></li>
												<li><a href="PayWithPointsService.jsp?code=<%= code%>">PayWithPoints</a></li>
											</ul>
								</li>
								<li>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 animate-box">
							...
							<form action="MoneyMovement.jsp" method="post">
							<table>
							<tr>
							<td>AccessToken</td>
							<td>
