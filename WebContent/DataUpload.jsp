		...
		<div id="fh5co-main">
			...
			<div class="fh5co-cards">
				<div class="container-fluid">
					...
					<div class="row">
					  <form action="StoreData.jsp" method="post" enctype="multipart/form-data">
						<div class="col-md-6 col-md-push-6">
							<h3 class="section-title">Big Data</h3>
							<p>CSV, Flat File, Web Services, Message Queue Integration</p>
						</div>
						<div class="col-md-6 col-md-pull-6">
							<div class="row">
							    <div class="col-md-6">
									<div class="form-group">
										<label for="textEdit">Upload the Data File</label>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="file" name="uploadDataFile" class="form-control">
									</div>
								</div>
