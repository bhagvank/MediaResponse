...
<ul class="sf-menu" id="fh5co-primary-menu">
        ...
        List<String> row = (List<String>)  rows.get(rowNumber);

        session.setAttribute("Row", row);
      
      out.println("<form action=UpdateData.jsp method=get>");
      out.println("<input type=hidden name=rowId value="+rowId+">");
       out.println("<input type=hidden name=columns value="+row.size());
       out.println("<table>");
       out.println("<tr>");
       int i=0;
	   for(String value: row)
	   {
		   ...
		   out.println("<input type=text name=column"+i+" value="+ value);
		   out.println("</td>");
		    i++; 
	   }
	   out.println("</tr>");
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="submit" name="uploadData" class="btn btn-primary">
									</div>
								</div>
