	...
	<body>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-cards">
			  ...
			  <div class="row">
						<div class="col-md-3">
			              <form action="ShowChart.jsp" method="get">
							<table>
							<tr>
							<td><label for="graphname">GraphName</label></td>
							<td><input id="graphName" type="text" name="graphname" ng-model="graphnameValue"> </td>
							</tr>
							<tr>
							<td><label for="graphtype">GraphType</label></td>
							<td><select id="graphtype" name="graphtype" ng-model="graphtypeValue">
							<option value="verticalbargraph">Vertical BarGraph</option>
							<option value="linegraph">Line Graph</option>
							<option value="piegraph">Pie Graph</option>
							</select></td>
							</tr>
							<tr>
							<td><label for="regressiontype">Regression</label></td>
							<td><select id="regressiontype" name="regressiontype">
							<option value="no">No Regression</option>
							<option value="linefit">Line Fit</option>
							</select> </td>
							</tr>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="submit" name="Generate Graph" class="btn btn-primary">
									</div>
								</div>
