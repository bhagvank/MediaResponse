    ...
    %>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-cards">
			  ...
			  <div class="row">
						<div class="col-md-3">
			              <form action="ShowSocialMediaSentiments.jsp" method="get">
							<table>
							<tr>
							<td><label for="socialmediaurl">SocialMediaURL</label></td>
							<td><input id="sociamediaurl" type="text" name="socialmediaurl" ng-model="socialmediaurlValue"> </td>
							</tr>
							
							<tr>
							<td><label for="keyword">KeyWord</label></td>
							<td><input id="keyword" type="text" name="keyword" ng-model="keywordValue"> </td>
							</tr>
							</table>
					    </div>
			</div>		    		
