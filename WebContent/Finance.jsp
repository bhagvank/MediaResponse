...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <%
        String code = "AAEkNTk0YzUyNGUtZGNlNS00MzFmLWFmZTgtM2EwOTkzNTdhMjFkH4KkOdtQfFfgRkSef0AP0Ha6bYYU46TgStRZpS38fNZx2cSt9LJ_KGVV6-9ntK-bPbKWdq5klRc83CBC53et4Kt1L3SNEaGmvs9gZZMuq2od2Ayki4tFq16l3_9F88pJB23caCnW9Eg20uoOD9WF6Q";
    
        String uuid = "dead4d3e-2872-421b-8419-6d6c4bd744b9";
				...
				<!-- <div id="fh5co-menu-logo"> -->
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li>
									<a href="right-sidebar.html" class="active">Dashboard</a>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-3">
							...
							<table>
							<tr>
							<td><img src="images/ProcurementBids.jpg" width="600" height="600"> </td>
							<td><img src="images/CrossBorderTransfers.jpg" width="600" height="600" ></td>
							...
							<tr>
							<td><img src="images/Cards_Loss_Stolen.jpg"  width="600" height="600"> </td>
							<td><img src="images/CardsTransactions.jpg" width="600" height="600" ></td>
							</tr>
