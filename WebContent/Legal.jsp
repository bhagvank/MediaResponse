	...
	<body>
								...
								<li>
									<a href="right-sidebar.html">Speech Management</a>
									 		<ul class="fh5co-sub-menu">
												...
												<li><A HREF="nonspeech.jsp" class="active"> NonSpeech Analysis</A> </li>
                                                <li><A HREF="timeAlert.jsp"> Time Alert</A></li>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-cards">
			  ...
			  <div class="row">
						<div class="col-md-3">
			              <form action="ShowLegalCodes.jsp" method="get">
							<table>
							<tr>
							<td><label for="nonSpeech">Legal Case</label></td>
							<td><input id="nonspeechtext" type="text" name="nonspeechtext" ng-model="nonspeechTextValue"> </td>
							</tr>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="submit" name="Show Sentiments" class="btn btn-primary">
									</div>
								</div>
