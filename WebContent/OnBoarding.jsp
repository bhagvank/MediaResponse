...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  //String code = request.getParameter("code");
   ...
   //String code = "AAEkNTk0YzUyNGUtZGNlNS00MzFmLWFmZTgtM2EwOTkzNTdhMjFkOnXxRxq_q6CAj2isz8N1WmUXnYSY-JvYf6nBfclwgoE3Uv8QOy3VPWEwCUNZUhA0LbOv3jZIylxprCVotZ9Jd6rikFR4Hv-uXZurztZZn7ZVmh_OdMBLwAWz4cdooZgwk2Hkl8v4PHKQAWOevccf7w";
   ...
   //String code = request.getParameter("code");
	...
	//	 String code = (String) request.getSession().getValue("code");

   //AuthorizationService authService = new AuthorizationService();
   
   //String accessToken = authService.getClientAccessToken(code, uuid);
   ...
   List<Map<String,String>> collection = parser.getData(responseJSon,"products");
					...
					<div class="row">
						<div class="col-md-3">         
			               <table border=1>
									...
									for(Map<String,String> product: collection)
									{
										out.println("<tr>");
