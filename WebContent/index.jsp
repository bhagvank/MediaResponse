...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <%
       //String code = "AAEkNTk0YzUyNGUtZGNlNS00MzFmLWFmZTgtM2EwOTkzNTdhMjFk-9TxybIrOktlP7yeiutu7DpqtyUdUzzEzRwzAu3H_EyUepqkmulIwPE8faVcHbtQYuN1WTlfNAJYhEse_Uq_J7LMoHwEdH3QU3yIZlPF8bQ1k_t9cAHYn7zwS4YXOpzUdTRTtPEHq2W5LIrlc78MXw";
        ...
        String json = service.getAccessToken(code);
        
        JsonParser parser = new JsonParser();
        Map<String,String> map = parser.getData(json);
        
        String accessToken = map.get("access_token");
        
        //out.println(accessToken);
        request.getSession().putValue("code", accessToken);
        //request.getSession().putValue("uuid",uuid);
    %>
		<!-- START #fh5co-header -->
				...
				<div class="col-md-12">
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							<h1 class="to-animate hero-animate-1">Architect Corner Profondo Deep Learning Platform</h1>
							<h2 class="to-animate hero-animate-2">Created by <a href="http://freehtml5.co" target="_blank">Architect Corner</a></h2>
							<p class="to-animate hero-animate-3"><a href="#" class="btn btn-outline btn-md">Prevention by Prediction</a></p>
						</div>
					</div>
				</div>
			</div>		
			...
			<div class="fh5co-cards">
				<div class="container-fluid">
					<div class="row animate-box">
						<div class="col-md-12 heading text-center"><h2>Products</h2></div>
					</div>
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 animate-box">
							<a class="fh5co-card" href="#">
								<img src="images/img_large_1.jpg" alt="Architect Corner" class="img-responsive">
								<div class="fh5co-card-body">
									<h3>Predictive Analytics</h3>
									<p>Prevention by Prediction</p>
								</div>
							</a>
						</div>
