...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		String[] sentiment = new String[28];
		  ...
		  Map<String,List<String>> foundSentiments = sentimentAnalyzer.getFoundSentiments(nonSpeechText);
		  
		  String message = null;
		  if(foundSentiments.size() >0)
		  {
			  message = "Found Risk in: '"+  nonSpeechText+"'";
		  }
		%>
			       ...
			       <div class="row">
			        ...
			        <div class="row">
						<div class="col-md-3">         
			               ...
			               <%  
			                 out.println("<tr>");
			                 out.println("<th> Compliance Risk Word");
			                 out.println("</th>");
			               ...
			               for(String senti:sentiment)
			               {
			            	 ...
			            	 List<String> occurrences = foundSentiments.get(senti);  
