...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <%
       ...
       String code = "AAEkNTk0YzUyNGUtZGNlNS00MzFmLWFmZTgtM2EwOTkzNTdhMjFkOnXxRxq_q6CAj2isz8N1WmUXnYSY-JvYf6nBfclwgoE3Uv8QOy3VPWEwCUNZUhA0LbOv3jZIylxprCVotZ9Jd6rikFR4Hv-uXZurztZZn7ZVmh_OdMBLwAWz4cdooZgwk2Hkl8v4PHKQAWOevccf7w";
        ...
        String uuid = "06b9c4c3-ea53-484f-a797-be6a39c6afe7";
    %>
		<!-- START #fh5co-header -->
  ...
  // out.println(code);
   ...
   List<Map<String,String>> collection = parser.getData(responseJSon,"customers");
						...
						<div class="col-md-3">         
			               <table border=1>
									...
									if(row != null)
									{
										...
										for(Map<String,String> customer: collection)
										{
											out.println("<tr>");
