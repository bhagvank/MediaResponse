				...
				<div class="container-fluid">
			       ...
			       <div class="row">
			        ...
			        <div class="row">
						<div class="col-md-3">         
			               <table border=1>
			               <form action="SaveUpdatedEntity.jsp" method="get">
				                  ...
				                  for(Map<String,String> entity: entities)
				                  {
				                	  ...
				                	  while(keyIterator.hasNext())
				                	  {
				                		  ...
				                		  if(key.equals("Fieldname"))
				                		  {
				                			...
				                			String fieldValue = searchEntities.get(0).get(value);  
				                			out.println("<td>");
				                			  
				                		    out.println("<label for=textEdit>"+value+"</label>");
				                		    		
				                		    out.println("</td>"); 		
				                		    
				                		    out.println("<td>");
				                		    out.println("<input type=text name="+value +" value="+fieldValue +" class=form-control>");
				                		    out.println("</td>"); 		
