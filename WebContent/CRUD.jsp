			       ...
			       <div class="row">
			        ...
			        <div class="row">
						<div class="col-md-3">         
			               ...
			               <tr>
							<td>
							<A HREF="EntityList.jsp?name=<%=entityName %>"><%=entityName %> List</A>
							</td>
							</tr>
							<tr>
							<td>
							<A HREF="CreateEntity.jsp?name=<%=entityName %>">Create <%=entityName %></A>
							</td>
							</tr>
							<tr>
							<td>
							<A HREF="UpdateEntity.jsp?name=<%=entityName %>">Update <%=entityName %></A>
							</td>
							</tr>
							<tr>
							<td>
							<A HREF="DeleteEntity.jsp?name=<%=entityName %>">Delete <%=entityName %></A>
							</td>
							</tr>
			              </table>
			            </div>
