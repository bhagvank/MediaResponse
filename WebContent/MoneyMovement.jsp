...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  //String code = request.getParameter("code");
    ...
    %>
		...
		<%
   //String code = request.getParameter("code");
   MoneyMovementService service = new MoneyMovementService();
   String responseJSon = service.getResponseJSon(code,uuid);
  // out.println(responseJSon);
   JsonParser parser = new JsonParser();
   List<Map<String,String>> collection = parser.getData(responseJSon,"sourceAccounts");
					...
					<div class="row">
						<div class="col-md-3">         
			               <table border=1>
									...
									for(Map<String,String> moneyMovement: collection)
									{
										out.println("<tr>");
										...
										for(String key:keySet)
										{
											String value = moneyMovement.get(key);
