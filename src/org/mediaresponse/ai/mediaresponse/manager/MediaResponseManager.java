 ...
 * 
 */
package org.mediaresponse.ai.mediaresponse.manager;


import org.mediaresponse.ai.mediaresponse.manager.MediaResponseManager;
import org.mediaresponse.ai.mediaresponse.manager.MediaSourceAnalyzer;
import org.mediaresponse.ai.mediaresponse.sentiment.SentimentAnalyzer;
import org.mediaresponse.ai.mediaresponse.util.WebApp;
import org.mediaresponse.ai.network.analysis.Network;
import org.mediaresponse.ai.nlp.processing.POSDetector;
...
public class MediaResponseManager {
	 ...
	 private Network network;
	  ...
	  public MediaContent getArticles(String url,String[] keywords)
	  {
	        MediaSourceAnalyzer analyzer = new MediaSourceAnalyzer();
	        
	        analyzer.setNetwork(this.network);
	        analyzer.setDetector(this.detector);
	  ...
	  public void analyzeAll()
	  {
		  ...
		  {
			 MediaContent  mediaContent = getArticles(urls[i],keywords);
			  
			 
			 Map<String,List<String>> foundArticles = mediaContent.getFoundArticles();
